...
<body>
<div class="container">
<img src="<c:url value='/resources/images/red.png'></c:url>" height="200px" width="1135px">
<nav class="navbar navbar-inverse">
<div class="collapse navbar-collapse" id="navbardemo">
<ul class="nav navbar-nav">
<li><a><img src="<c:url value='/resources/images/icon.jpg'></c:url>" height="40px" width="75px"></a></li>
